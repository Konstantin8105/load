...
func ExampleRectangle() {
	...
	// z = 10.000 m
	// Wsum[Side of rectangle: A] = -610.4 Pa
	// Wsum[Side of rectangle: B] = -488.3 Pa
	// Wsum[Side of rectangle: C] = -305.2 Pa
	// Wsum[Side of rectangle: D] =  482.6 Pa
	// Wsum[Side of rectangle: E] = -301.6 Pa
	// Summary D and E:
	// Wsum[z = 10.000 m] =  784.3 Pa
	//
	// z = 15.000 m
	// Wsum[Side of rectangle: A] = -705.1 Pa
	// Wsum[Side of rectangle: B] = -564.1 Pa
	// Wsum[Side of rectangle: C] = -352.6 Pa
	// Wsum[Side of rectangle: D] =  557.9 Pa
	// Wsum[Side of rectangle: E] = -348.7 Pa
	// Summary D and E:
	// Wsum[z = 15.000 m] =  906.5 Pa
}
