...
func ExampleRectangle() {
	...
	// |        |        |            |           |              |            |
	// |      A |  1.076 |   -499.9   |   -712.3  | 10.036       |   -641.5   |
	// |      B |  4.304 |   -399.9   |   -569.8  | 10.036       |   -513.2   |
	// |      C |  1.940 |   -249.9   |   -356.1  | 10.036       |   -320.7   |
	// |      D |  5.380 |   +352.2   |   +575.6  | 10.244       |   +501.1   |
	// |      E |  5.380 |   -220.1   |   -359.7  | 10.244       |   -313.2   |
	// z = 10.000 m
...
func ExampleCylinder() {
	...
	// | m      m                           | Pa     Pa     Pa     |
	// |                                    |                      |
	// |  2.800  2.800  0.750  0.850  1.000 |  175.3  130.0  305.3 |
	// |  5.000  5.000  0.750  0.850  1.000 |  175.3  130.0  305.3 |
	// | 10.000 10.000  1.000  0.760  1.000 |  233.7  155.0  388.7 |
	// | 10.100 10.100  1.003  0.759  1.000 |  234.4  155.2  389.6 |
	// Wsum[z =  2.800 m] =  305.3 Pa
	// Wsum[z =  5.000 m] =  305.3 Pa
	// Wsum[z = 10.000 m] =  388.7 Pa
}
